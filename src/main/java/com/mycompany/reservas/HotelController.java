...
import com.mycompany.reservas.HotelFacade;
...
public class HotelController implements Serializable {
    ...
    @EJB
    private com.mycompany.reservas.HotelFacade ejbFacade;
    ...
    public static class HotelControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Hotel) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + HotelController.class.getName());
            }
        }
    }
}
